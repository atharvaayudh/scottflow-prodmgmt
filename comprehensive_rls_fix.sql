...
-- This addresses the infinite recursion issue and provides proper security
...
-- ==============================================
-- 2. CREATE SAFE RLS POLICIES
-- ==============================================

-- Company config policies - using auth.uid() directly instead of querying users table
